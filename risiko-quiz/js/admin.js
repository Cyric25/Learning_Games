  ...
  subBlock.innerHTML = `
    <div class="cat-header" style="background:rgba(255,255,255,0.05);">
      ...
      <div style="display:flex;gap:0.5rem;align-items:center;">
        ...
        ${!hasSubsubs ? `<button class="btn btn-success btn-sm" onclick="openQuestionModal('${cat.id}', '${sub.id}')">+ Frage</button>` : ''}
  ...
  subsubBlock.innerHTML = `
    <div class="cat-header" style="background:rgba(255,255,255,0.03);">
      ...
      <div style="display:flex;gap:0.5rem;align-items:center;">
        ...
        ${!hasL4 ? `<button class="btn btn-success btn-sm" onclick="openQuestionModal('${cat.id}', '${sub.id}', null, '${subsub.id}')">+ Frage</button>` : ''}
...
async function saveQuestion() {
  ...
  if ((targetNode.subcategories || []).length > 0) { showAlert('qm-alert', 'danger', 'Fragen können nicht direkt in Kategorien mit Unterkategorien gespeichert werden. Bitte zuerst eine Unterkategorie wählen.'); return; }
